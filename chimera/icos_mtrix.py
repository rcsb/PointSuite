...
d.multimer_type.set(d.multimer_noncrystal)
viewer.windowSize = (512, 512)  # Set Chimera window size
runCommand('set bg_color white')


def make_images(pdb_files):
     # open structure
     molecules = []
     for i in pdb_files:
          molecule = openModels.open(i, 'PDB')[0]
